import type { ServiceProductInput } from '@/types';
...
// l'admin depuis l'app — ce fichier ne sert qu'à ne pas partir d'une app vide.
// Photos libres de droit (Unsplash).
export const SEED_CATALOG: ServiceProductInput[] = [
  {
    type: 'service',
